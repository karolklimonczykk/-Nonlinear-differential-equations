...
text console window, file). A new GUI element there is a main menu. <br> Two common design patterns will be used in the application code: the construction pattern production method and functional pattern observer:
<ul>
